...
*/
    ...
    var myCalendar = createCalendar({
        ...
        data: {
            // Event title
            title: "Benjamin and Nithya's Wedding",

            // Event start date
            start: new Date('Aug 29, 2020 16:00'),
            ...
            end: new Date('Aug 30, 2020 20:00'),

            // Event Address
            address: '37 Rue du Calvaire, 49270 Orée-d Anjou, France',

            // Event Description
            description: "Nous avons hâte de passer cette journée avec vous. Pour toutes questions éventuelles, n'hésitez pas à nous contacter."
        }
    });
    ...
    $('#rsvp-form').on('submit', function (e) {
        ...
        // } else {
            $.post('https://script.google.com/macros/s/AKfycbwzE5LgHMPrAcWNTdl4OFsTtjLbSiLXbmMBCfGn/exec', data)
                .done(function (data) {
                    console.log(data);
                    $('#alert-wrapper').html('');
...
// Google map
function initMap() {
    var itc_kol = {lat: 47.190070, lng: -1.683468};
...
function initBBSRMap() {
    var la_fiesta = {lat: 47.190070, lng: -1.683468};
    var map = new google.maps.Map(document.getElementById('map-canvas'), {
        zoom: 15,
        center: la_fiesta,
        scrollwheel: false
